...
folder_path = "E:\Sama\InternshipWH\Image\Frames"
...
def main(image_path):
    ...
    cv2.imwrite("E:\Sama\InternshipWH\Image\CubeMap\cube_map{}.png".format(i), cube_map_img)


if __name__ == "__main__":
    #image_path = "E:\Sama\InternshipWH\Image\Images\WhatsApp Image 2024-08-25 at 1.35.51 PM.jpeg"
    i = 0
    for i in range(len(folder_files)):
        image_path = os.path.join(folder_path, folder_files[i])
        main(image_path)